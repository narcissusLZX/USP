...
class JPypeSetup(object):
    ...
    def setupFiles(self) :
        cpp_files = [
                 map(lambda x : "./src/native/common/"+x, os.listdir(r"E:\USP\stanford-parser-python-r22186\3rdParty\jpype\JPype-0.5.4.1\JPype-0.5.4.1/src/native/common")),
                 map(lambda x : "./src/native/python/"+x, os.listdir(r"E:\USP\stanford-parser-python-r22186\3rdParty\jpype\JPype-0.5.4.1\JPype-0.5.4.1/src/native/python")),
                 ]
